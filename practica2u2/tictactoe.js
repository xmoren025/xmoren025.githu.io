...
const selectBtnN = selectBox.querySelector(".options.player2");
...
function bot(){
    ...
    if(runBot){
        ...
        if(array.length> 0){
            if(players.classList.classList.contains("player")){
                playerSign = "M";
                allBox[randomBox].innerHTML = `<i class="${player1Icon}"></i>`;
                allBox[randomBox].setAttribute("id", playerSign);
                players.classList.add("active");
            }else{
                allBox[randomBox].innerHTML = `<i class="${player2Icon}"></i>`;
                players.classList.remove("active");
                allBox[randomBox].setAttribute("id", playerSign);
            }
            selectWinner();
